 ...
 {!! Form::model($fiador ?? '', ['route' => Route::currentRouteName() == 'fiador.create' ? ['fiador.store'] : ['fiador.update', $fiador ?? ''], 'method' => Route::currentRouteName() == 'fiador.create' ? 'post' : 'put', 'class' => "kt-form"]) !!}
    ...
    <div class="kt-portlet__body">
        ...
        <div class="form-group">
            ...
            {!! Form::select('certidaoPermanente', \App\Fiador::getCertidaoPermanenteArray(), null, ['class' => 'form-control '.($errors->has('certidaoPermanente') ? 'is-invalid' : ''), 'type' => 'number', 'step' => 1, 'min' => 0, 'required' => false]) !!}
